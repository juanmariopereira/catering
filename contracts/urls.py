...
urlpatterns = [
    ...
    path('ajax/cliente/<int:cliente_id>/direccion/', views.ajax_direccion_cliente, name='ajax_direccion_cliente'),
    path('ajax/cliente/<int:cliente_id>/ultimo-contrato-direccion/', views.ajax_ultimo_contrato_direccion, name='ajax_ultimo_contrato_direccion'),
